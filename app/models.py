...
class Facility(models.Model):
    FAC_TYPES = (('CWS', 'Community Water System'), ('TNCWS', 'Transient Non-Community Water System'),
                 ('NTNCWS', 'Non-Transient Non-Community Water System'), ('OTHER', 'Other'))
    
    facility_name = models.CharField(max_length=255)
    pws_id = models.CharField(max_length=255, unique=True)
    registry_id = models.CharField(max_length=12) # not unique because multiple facilities can have one registry ID
